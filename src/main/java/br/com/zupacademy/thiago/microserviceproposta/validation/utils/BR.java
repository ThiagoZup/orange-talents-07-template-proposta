package br.com.zupacademy.thiago.microserviceproposta.validation.utils;

//Fonte: https://github.com/adrianoluis/misc-tools/blob/2e77e7b153d74fa43236adaadbd4a660972a90bb/src/main/java/net/adrianoluis/tools/util/DocumentUtil.java
...
public class BR {
    ...
    public static boolean isValidCep(String cep) {
        if (cep.matches("[0-9]{5}-[0-9]{3}")) return true;
